#Módulo que controla la subventana "Lecturas" 
...
class Lecturas(QtWidgets.QDialog):
    ...
    def anadirlectura(self):
        """Comprobamos que el campo título no esté vacío"""
