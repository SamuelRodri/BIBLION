...
class Ui_Borrar_Base(object):
    def setupUi(self, Borrar_Base):
        ...
        self.widget = QtWidgets.QWidget(Borrar_Base)
        self.widget.setGeometry(QtCore.QRect(30, 10, 209, 34))
        ...
        self.widget1 = QtWidgets.QWidget(Borrar_Base)
        self.widget1.setGeometry(QtCore.QRect(60, 70, 158, 25))
        self.widget1.setObjectName("widget1")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.widget1)
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.borrar_borrar = QtWidgets.QPushButton(self.widget1)
